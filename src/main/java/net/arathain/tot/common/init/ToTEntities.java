...
public class ToTEntities {
    ...
    public static final EntityType<ArachneEntity> ARACHNE = createEntity("arachne", ArachneEntity.createArachneAttributes(), FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, ArachneEntity::new).dimensions(EntityDimensions.fixed(1.8F, 2.1F)).build());
    //string hell
