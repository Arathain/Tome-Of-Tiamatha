...
public class ToTEntities {
    ...
    public static final EntityType<ArachneEntity> ARACHNE = createEntity("arachne", ArachneEntity.createArachneAttributes(), FabricEntityTypeBuilder.create(SpawnGroup.CREATURE, ArachneEntity::new).dimensions(EntityDimensions.fixed(1.8F, 1.9F)).build());
    //string hell
