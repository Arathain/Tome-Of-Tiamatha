...
public class ToTScaleTypes {
    public static final ScaleModifier MODIFY_WIDTH_MODIFIER = register(ScaleRegistries.SCALE_MODIFIERS, "modify_width", new TypedScaleModifier(() -> ToTScaleTypes.MODIFY_WIDTH_TYPE));
    public static final ScaleModifier MODIFY_HEIGHT_MODIFIER = register(ScaleRegistries.SCALE_MODIFIERS, "modify_height", new TypedScaleModifier(() -> ToTScaleTypes.MODIFY_HEIGHT_TYPE));
    ...
    private static <T> T register(Map<Identifier, T> registry, String name, T entry) {
        return ScaleRegistries.register(registry, new Identifier(TomeOfTiamatha.MODID, name), entry);
    }
