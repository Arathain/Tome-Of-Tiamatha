...
public class DriderPlayerComponent implements AutoSyncedComponent, ServerTickingComponent {
    ...
    public static final EntityAttributeModifier DRIDER_MOVEMENT_SPEED_MODIFIER = new EntityAttributeModifier(UUID.fromString("53f0d4fe-52f6-4e23-b4d8-023a577fea2b"), "Drider modifier", 1.5, EntityAttributeModifier.Operation.MULTIPLY_TOTAL);
